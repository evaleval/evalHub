...
#   timestamp: 2025-09-11T12:13:10+00:00
...
class Quantization(BaseModel):
    ...
    quantization_type: QuantizationType = Field(..., description='Quantization type')
...
class SampleIdentifier(BaseModel):
    ...
    hf_split: Optional[HfSplit] = Field(
        None, description='HuggingFace split identifier'
    )
    hf_index: Optional[int] = Field(
        None, description='Index in the HuggingFace dataset'
    )
